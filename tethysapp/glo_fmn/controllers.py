...
def home(request):
    ...
    return render(request, 'glo_fmn/home.html', context)
...
def add_point(request):
    ...
    return render(request, 'glo_fmn/add_point.html', context)
...
def approve_points(request):
    ...
    # initialize session
    Session = GloFmn.get_persistent_store_database('layers', as_sessionmaker=True)
    session = Session()
    ...
    return render(request, 'glo_fmn/approve_points.html', context)
...
def add_polygon(request):
    ...
    return render(request, 'glo_fmn/add_polygon.html', context)
...
def approve_polygons(request):
    ...
    return render(request, 'glo_fmn/approve_polygons.html', context)
...
def add_new_layer(request):
    ...
    return render(request, 'glo_fmn/add_new_layer.html', context)
...
def delete_layer(request):
    ...
    return render(request, 'glo_fmn/delete_layer.html', context)
...
def set_layer_style(request):
    ...
    return render(request, 'glo_fmn/set_layer_style.html', context)
...
def add_endpoint(request):
    ...
    return render(request, 'glo_fmn/add_endpoint.html', context)
...
def delete_endpoint(request):
    ...
    return render(request, 'glo_fmn/delete_endpoint.html', context)
